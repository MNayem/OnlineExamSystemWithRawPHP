...
<table class="table table-bordered table-dark">
  <th colspan="6"><h2 style="text-align: center; color: #000; font-weight: bold; font-family: comic sans MS">EXAM LIST</h2></th>
  <tr align="center">
    <td><b>SI.No.</b></td>
    <td><b>Topic</b></td>
...
while($row = mysqli_fetch_array($result)) {
    ...
    <td>'.$sahi*$total.'</td>
    <td>'.$time.'&nbsp;min</td>
	   <td><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn btn-danger" style="margin:0px; border-radius:0%;"><span class="glyphicon glyphicon-trash"  aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td>
    </tr></tbody>';
}
$c=0;
echo '</table></div>';
...
<table class="table table-bordered table-dark">
   <th colspan="3"><h2 style="text-align: center; color: #000; font-weight: bold; font-family: comic sans MS;">RANKING OF THE STUDENT</h2></th>
...
<th colspan="7"><h2 style="text-align: center; color: #000; font-family: comic sans MS; font-weight: bold;">USER LIST</h2></th>
<tr align="center">
  <td><b>SI.No.</b></td>
  <td><b>Name</b></td>
  <td><b>Gender</b></td>
...
echo  '<div class="panel"><table class="table table-bordered table-dark">
  <th colspan="8"><h2 style="text-align: center; color: #000; font-family: comic sans MS; font-weight: bold;">FEEDBACK LIST</h2></th>
  <tr align="center">
    <td><b>SI.No.</b></td>
    <td><b>Subject</b></td>
    <td><b>Email</b></td>
...
echo '
<div class="row" id="examadd">
<span class="title1" style="margin-left:40%;font-size:30px; font-weight: bold; font-family: comic sans MS;"><b>Enter Exam Details</b></span><br /><br />
