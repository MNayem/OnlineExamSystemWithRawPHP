...
<body>
  ...
  echo  '<div class="panel"><table class="table table-bordered table-dark">
  <th colspan="6"><h2 style="text-align: center; color: #000; font-weight: bold; font-family: comic sans MS;">Available TESTS</h2></th>
  <tr align="center">
    <td><b>SI.No.</b></td>
    <td><b>Topic</b></td>
  ...
  if($rowcount == 0){
  	echo '<tr align="center"><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
  ...
  {
  echo '<tr style="color:#2db44a" align="center"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This exam has been already solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
  ...
  /*$etitle=mysqli_query($con,"SELECT title FROM quiz WHERE eid='$eid' AND email='$email' " )or die('Error157');*/
  ...
  while($row=mysqli_fetch_array($q) )
  {
    ...
    $r=$row['sahi'];
    $qa=$row['level'];
    $etitle=mysqli_query($con,"SELECT title FROM quiz WHERE  eid='$eid' " )or die('Error288');
    while($row=mysqli_fetch_array($etitle) )
      {
        $title=$row['title'];
      }
  echo '<tr style="color:#202020"><td>Exam Topic</td><td>'.$title.'</td></tr>
  ...
  <th colspan="9"><h2 style="text-align: center; color: #000; font-family: comic sans MS; font-weight: bold;">YOUR EXAM HISTORY</h2></th>
  ...
  $c++;
  echo '<tr align="center"><td>'.$c.'</td><td>'.$title.'</td><td>'.$qa.'</td><td>'.$r.'</td><td>'.$w.'</td><td>'.$s.'</td></tr>';
  }
  echo'</table></div>';
  }
  ...
  echo  '<div class="panel title">
  <table class="table table-bordered table-dark" >
  <th colspan="3"><h2 style="text-align: center; color: #000; font-family: comic sans MS; font-weight: bold;">RANKING OF STUDENTS</h2></th>
    <tr style="color:red" align="center">
      <td><b>Rank</b></td>
      <td><b>Name</b></td>
      <td><b>Score</b></td>
  ...
  $c++;
  echo '<tr align="center"><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$s.'</td><tr>' ;
  }
  echo '</table></div>';}
  ?>
