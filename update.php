...
include_once 'dbConnection.php';
	...
	if(@$_GET['fdid'] && $_SESSION['key']=='Nayem12345678') {
	$id=@$_GET['fdid'];
...
//delete user
	if(isset($_SESSION['key'])){
	if(@$_GET['demail'] && $_SESSION['key']=='Nayem12345678') {
	$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='Nayem12345678') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='Nayem12345678') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='Nayem12345678') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='Nayem12345678')
{
